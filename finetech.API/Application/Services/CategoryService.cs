...
namespace fintech.API.Application.Services
{
    public class CategoryService(ICategoryRepository categoryRepository,
        ...
        IFinancialTransactionRepository transactionRepository) : ICategoryService 
    {
        ...
        { 
            ...
            return category.MapToResponseDto();
        ...
        public async Task<IEnumerable<CategoryResponseDto>> GetAllCategoriesAsync(Guid userId)
        {
            ...
            return categories.Select(c => c.MapToResponseDto());
        }
        ...
        public async Task<ConfirmationResponseDto> SetCategoryEssentialAsync(UserCategorySettingsRequestDto dto,Guid categoryId,  Guid userId)
        {
            ...
            {
                var newUserCategorySettings = dto.MapToEntity();
